...
- ML model for predicting calibrated confidence for optimization detecting (LightGBM)
- Frontend (Next.js / SSR, TailwindCSS)
- Backend (FastAPI with Clean Archeticture, Websockets for real-time detecting, alembic for recording results)
- Database (PostgreSQL for memorization students, teachers, comments)
